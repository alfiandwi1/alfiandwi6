...
if(isset($_POST['username'])) {
    ...
    if(mysqli_num_rows($cek) >0) {
        ...
        echo '<script>alert("selamat datang, jangan lupa logout setelah selesai"); location.href="index.php"</script>';
    }
    else {
                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div class="form-floating mb-3">
                                                ...
                                                <label for="inputEmail">Ussername</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                    ...
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="register.php">Belum punya akun? register
                                            !</a></div>
                                    </div>
                                </div>
                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; alfirdynsh</div>
                            <div>
